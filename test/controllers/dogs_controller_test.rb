...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { born_at: @dog.born_at, male: @dog.male, name: @dog.name, user_id: @dog.user_id }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { born_at: @dog.born_at, male: @dog.male, name: @dog.name, user_id: @dog.user_id }
    assert_redirected_to dog_path(assigns(:dog))
  end
